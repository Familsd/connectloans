    ...
    <section className="pb-16 bg-background" ref={ref}>
      {/* Google Map Embed */}
        <div className={`rounded-2xl overflow-hidden border border-border ${isVisible ? "animate-fade-in animation-delay-500" : "opacity-0"}`}>
          <iframe
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3773.8686455972543!2d72.8320374!3d18.9310953!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3be7d1c73a0d5cad%3A0xc70a25a7209c733c!2sMumbai%20Financial%20District!5e0!3m2!1sen!2sin!4v1234567890"
            width="100%"
            height="300"
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {helpItems.map((item, index) => (
            <Link
              key={item.title}
              href={item.link}
              className={`group bg-card rounded-2xl p-6 border border-border hover:border-primary/30 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 ${

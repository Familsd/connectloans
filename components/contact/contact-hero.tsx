    ...
    <section className="relative py-24 bg-secondary overflow-hidden" ref={ref}>
      ...
      <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
        <div className={`text-center max-w-3xl mx-auto ${isVisible ? "animate-fade-in-up" : "opacity-0"}`}>
          <p className="text-sm font-medium text-primary uppercase tracking-wider">Contact Us</p>
          <h1 className="mt-3 text-4xl font-bold tracking-tight text-foreground sm:text-5xl text-balance">
            Contact               <span className="text-primary">Connect </span> Loans
          </h1>
          <p className="mt-6 text-lg text-muted-foreground leading-relaxed">
            We&apos;re here to help you with your loan requirements. Reach out to our team for loan consultation, 
            eligibility guidance, and expert financial assistance.
          </p>
        </div>
      </div>
    </section>

          ...
          <div className="flex flex-col items-center justify-between gap-6 md:flex-row">
            <div className="text-center md:text-left">
              <h2 className="text-2xl font-bold text-primary-foreground md:text-3xl">
                Get Expert Financial Guidance for Your Loan
              </h2>
              <p className="mt-2 text-primary-foreground/80 max-w-lg">
                 Whether you need a housing loan, business finance, or loan against property, our expert loan consultants 
            are here to help you find the best solution. Explore our comprehensive loan services today.
          </p>
            </div>
